...
WebUI.selectOptionByValue(findTestObject('Object Repository/apointment/select_Tokyo CURA Healthcare Center        _5b4107'), 
    'Hongkong CURA Healthcare Center', true)

WebUI.setText(findTestObject('Object Repository/apointment/textarea_Comment_comment'), 'tes')

WebUI.doubleClick(findTestObject('Object Repository/apointment/button_Book Appointment'))


WebUI.click(findTestObject('Object Repository/apointment/td_15'))
